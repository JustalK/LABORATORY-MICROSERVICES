...
var Internet = /** @class */ (function () {
    function Internet(faker) {
        ...
        for (var _i = 0, _a = Object.getOwnPropertyNames(Internet.prototype); _i < _a.length; _i++) {
            var name_1 = _a[_i];
     ...
     */
    Internet.prototype.avatar = function () {
        return ('https://cloudflare-ipfs.com/ipfs/Qmd3W5DuhgHirLHGVixi6V76LhCkZUz6pnFt5AJBiyvHye/avatar/' +
     ...
     * @param provider
     */
    Internet.prototype.email = function (firstName, lastName, provider) {
        provider || (provider = this.faker.random.arrayElement(this.faker.definitions.internet.free_email));
        return (this.faker.helpers.slugify(this.faker.internet.userName(firstName, lastName)) +
            '@' +
            provider);
    };
    /**
     ...
     * @param lastName
     */
    Internet.prototype.exampleEmail = function (firstName, lastName) {
     ...
     * @param lastName
     */
    Internet.prototype.userName = function (firstName, lastName) {
        var result;
     ...
     */
    Internet.prototype.protocol = function () {
     ...
     */
    Internet.prototype.httpMethod = function () {
        var httpMethods = [
            'GET',
            'POST',
            'PUT',
     ...
     */
    Internet.prototype.url = function () {
     ...
     */
    Internet.prototype.ip = function () {
        var _this = this;
        var randNum = function () {
            return _this.faker.datatype.number(255).toFixed(0);
        };
        var result = [];
        for (var i = 0; i < 4; i++) {
            result[i] = randNum();
     ...
     */
    Internet.prototype.ipv6 = function () {
        var _this = this;
        var randHash = function () {
            var result = '';
            for (var i = 0; i < 4; i++) {
                result += _this.faker.random.arrayElement([
                    '0',
                    '1',
                    '2',
                    '3',
     ...
     */
    Internet.prototype.port = function () {
     ...
     */
    Internet.prototype.userAgent = function () {
     ...
     * @param baseBlue255
     */
    Internet.prototype.color = function (baseRed255, baseGreen255, baseBlue255) {
        if (baseRed255 === void 0) { baseRed255 = 0; }
        if (baseGreen255 === void 0) { baseGreen255 = 0; }
        if (baseBlue255 === void 0) { baseBlue255 = 0; }
        // based on awesome response : http://stackoverflow.com/questions/43044/algorithm-to-randomly-generate-an-aesthetically-pleasing-color-palette
        var red = Math.floor((this.faker.datatype.number(256) + baseRed255) / 2);
        var green = Math.floor((this.faker.datatype.number(256) + baseGreen255) / 2);
     ...
     * @param sep
     */
    Internet.prototype.mac = function (sep) {
        var i;
        var mac = '';
        var validSep = ':';
     ...
     * @param prefix
     */
    Internet.prototype.password = function (len, memorable, pattern, prefix) {
        var _this = this;
        len || (len = 15);
        ...
        var _password = function (length, memorable, pattern, prefix) {
            ...
            if (memorable === void 0) { memorable = true; }
            ...
            n = _this.faker.datatype.number(94) + 33;
